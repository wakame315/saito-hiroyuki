...
CRanking::RankingData * CRenderer::m_RankingDeta[MAX_RANKING] = {};
...
void CRenderer::Draw(void)
{
	...
	if (SUCCEEDED(m_pD3DDevice->BeginScene()))
	{
		...
		case CManager::MODE_RESULT:
			...
			{
				m_RankingDeta[nCnt] = CManager::GetRankinData() + nCnt;
			}
			CRanking::Ranking(*m_RankingDeta, m_RankingDeta[0]->nRank);
